...
! Expose subroutine InterpSR to users of this DLL
!
!!DEC$ ATTRIBUTES DLLEXPORT,stdcall::InterpSR
!!DEC$ ATTRIBUTES VALUE::QN
!!DEC$ ATTRIBUTES VALUE::SRN
!!DEC$ ATTRIBUTES REFERENCE::QAngleA
!!DEC$ ATTRIBUTES REFERENCE::SRAngleA
!!DEC$ ATTRIBUTES REFERENCE::SRVGiven
!!DEC$ ATTRIBUTES REFERENCE::SRHGiven
!!DEC$ ATTRIBUTES REFERENCE::SRVInt
!!DEC$ ATTRIBUTES REFERENCE::SRHInt
