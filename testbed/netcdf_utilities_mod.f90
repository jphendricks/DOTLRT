...
if (size(dimnames) >= 4) then
   print *, routine, 'only 1d, 2d and 3d character variables supported'
...
ndims = size(dimnames)
if (ndims > 4) then
   print *, routine, 'only 1d, 2d, 3d and 4d integer variables supported'
...
ndims = size(dimnames)
if (ndims > 4) then
   print *, routine, 'only 1d, 2d, 3d and 4d real variables supported'
...
ndims = size(dimnames)
if (ndims > 4) then
   print *, routine, 'only 1d, 2d, 3d and 4d double variables supported'
