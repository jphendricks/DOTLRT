...
% surface parameters
num_surf_angles = 4; % number of angles for surface refelctivity
%     surf_inp(i,j) = surface reflectivity
...
[Tb_inp,tau,Tb,dTb_dT,dTb_dp,dTb_dq,dTb_dw,stream_angles] = mex_matlab_mrt( inp_height, inp_theta, num_sb_freqs, instr_spec, ...
                                                                            num_streams, num_surf_angles, surf_inp, nz, atm_inp);                                                                    