...
! assign values to update manipulation variable tree
  ...
  update_man(iman)%val1=dlog10(cur_lay%cloud%tot)
  update_man(iman)%val2=cur_lay%cloud%pk
  update_man(iman)%val3=cur_lay%cloud%std

  iman = 7
  update_man(iman)%doit= .false.
  update_man(iman)%typ = 'precip'
  update_man(iman)%val1=dlog10(cur_lay%precip%tot)
  update_man(iman)%val2=cur_lay%precip%pk
  update_man(iman)%val3=cur_lay%precip%std
