...
NCDIR = $(HOME)/local
NCDIR = $(HOME)/local
NCMOD = /usr/lib64/gfortran/modules
NCLIB = /lib64
FC =		gfortran
...
FFLAGS =	-g -Wall -Wextra -I$(NCMOD) -fbounds-check -Wuninitialized -Wunused -ffree-line-length-none -fbounds-check -fbacktrace -ffpe-trap=invalid,zero,overflow 	
