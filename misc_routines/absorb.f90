...
!
      IMPLICIT NONE
!
      real FREQY    ! (GHz) frequency of radiation
      real TEMP     ! (K) air temperature
      real PRES     ! (mb) air pressure
      real RH       ! (%) relative humidity
      real atm_ext  ! (-) extinction coefficient
      real T        ! (K) air temperature
      real TS       ! (K) reference air temperature (?)
      real EWS
      real ESLOG
      real ES
      real WS       ! (kPa) saturation water vapor pressure
      real W        
      real E        ! water vapor partial pressure [kPA]
      real Tc       ! temperature [C]
      real Pb       ! total pressure [KPa]
      real R        ! cloud water content [g/m^3]
!
...
!
      IMPLICIT NONE
      REAL    F, Pbkpa, Ekpa, Tc, W, ABSCOF
      INTEGER IFIRST, I, ICE

      REAL AT1, AT2, AT3, AT4
      REAL GAMMA, S, DELTA, So, GAMMAo, Sn
      REAL GAMH, GAMD2, DELH
      REAL fD, fS, Eps, Epinf, Eopt
      REAL Ai, Bi, fice
      REAL V, P, Pb, E
...
! Common block for oxygen and water vapor lines
      REAL    F0O2(44), A(6,44)
      REAL    F0H2O(35), B(6,35)
      real    A1(44),A2(44),A3(44),A4(44),A5(44),A6(44)
      real    B1(35),B2(35),B3(35),B4(35),B5(35),B6(35)
